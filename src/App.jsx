    ...
    <nav className='navs'>
      <div className='nav-left'>
        <div className='logo' onClick={home}>
          <h1>Carttier</h1>
          <svg id='Layer_1' version='1.1' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'>
            <g>
              <g id='fill'>
                <path
                  className='st0'
              ...
              <g id='line_copy'>
                <path className='st2' d='M31.6,40.3l3.7-1.9c-0.1-0.1-0.2-0.3-0.3-0.4c-1.2,0.7-2.5,1.3-3.7,2C31.5,40,31.6,40.2,31.6,40.3z' />
                <path
                  className='st2'
                ...
                />
                <path className='st2' d='M56.4,59.8c-0.5,3.4-1,6.7-1.5,10.1l9.2,1.7c0.1,0,0.3,0.1,0.4,0.2C64.2,71.4,64,71,64,70.5    c0-3.1,0.1-6.2,0.2-9.3L56.4,59.8z' />
                <path className='st2' d='M50.8,29.9c-1.6,0.8-3.3,1.6-4.9,2.4c0.1,0.1,0.2,0.3,0.3,0.4l4.7-2.5C50.9,30.1,50.9,30,50.8,29.9z' />
                <path className='st2' d='M67.2,58.9l9.4,1.7c0.3-3.6,0.7-7.1,1-10.7l-9.5-1.4C67.7,51.9,67.4,55.4,67.2,58.9z' />
                <path
                  className='st2'
      ...
      <div className='acct-cart-option'>
        <div className='search'>
          ...
          <svg enableBackground='new 0 0 32 32' id='Glyph' version='1.1' viewBox='0 0 32 32' width='30' xmlns='http://www.w3.org/2000/svg'>
            <path
      ...
      <div className='ham-menu' onClick={toggle}>
        <svg enableBackground='new 0 0 32 32' id='Filled_Line' version='1.1' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
          <line fill='none' id='XMLID_837_' stroke='#200F60' strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' strokeWidth='2' x1='7' x2='25' y1='16' y2='16' />
          <line fill='none' id='XMLID_836_' stroke='#200F60' strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' strokeWidth='2' x1='7' x2='25' y1='25' y2='25' />
          <line fill='none' id='XMLID_835_' stroke='#200F60' strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit='10' strokeWidth='2' x1='7' x2='25' y1='7' y2='7' />
        </svg>
      </div>
    </nav>
  )
  ...
  return (
    <>
      <footer>
        ...
        <p>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nemo ex ducimus cumque assumenda quae, sapiente incidunt, eius ab omnis a enim inventore velit corporis repellat necessitatibus sit,
          perferendis laboriosam fuga in. Aliquid perspiciatis veritatis eum facere corporis, repellat adipisci quas.
        </p>
      </footer>
    </>
  )
