...
function ShoppingItem({ addToCart, itemInfo, fav, addFav }) {
  return (
    <>
      <div className='item'>
        <div className='img'>
          <img src={img} alt='itemImage' onClick={itemInfo} />
          <span className='fav' onClick={addFav}>
            {fav ? (
              <svg viewBox='0 0 24 24' width='24' xmlns='http://www.w3.org/2000/svg'>
                <path d='M12 22c8-4 11-9 11-14a6 6 0 0 0-11-3.314A6 6 0 0 0 1 8c0 5 3 10 11 14Z' fill='#0de045' className='fill-232323'></path>
              </svg>
            ) : (
